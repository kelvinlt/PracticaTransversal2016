...
$sql=("insert into votar_grupo(id_usuario,id_grupox ,concierto_puntuacion,concierto_comentario)  values('".$_SESSION['id_usuario']."','".$_SESSION['votar_concierto']."','".$_POST['valoracion']."','".$_POST['comentario']."')") or die ("no se puede conectar y conseguir el select");
