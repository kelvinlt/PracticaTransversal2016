...
$sql=("insert into votar_local(id_usuario,id_local,concierto_puntuacion,concierto_comentario)  values('".$_SESSION['id_usuario']."','".$_SESSION['votar_local']."','".$_POST['valoracion']."','".$_POST['comentario']."')") or die ("no se puede conectar y conseguir el select");
