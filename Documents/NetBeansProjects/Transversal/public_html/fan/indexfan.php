...
<html>
    <head>
        ...
        <link href="indexfan.css" rel="stylesheet" type="text/css"/>
  ...
  ga('send', 'pageview');
    ...
    <body background="/cube.jpg">
        ...
        <div class="tablas">
                        ...
                        $consulta=$conexion->query("SELECT concierto.id_concierto,concierto.nombre as cnombre,concierto.fecha as fecha,concierto.estado as estado,usuarios.nombre as lnombre,ciudad.nombre as ciudad FROM concierto INNER JOIN usuarios ON concierto.id_local = usuarios.id_usuario INNER JOIN ciudad ON usuarios.id_ciudad = ciudad.id_ciudad where estado='aceptado'") or die("no se puedde conectar ni recibir valores");
                        ?>
                        <table class="tindex" border="1">
                        <th class="columnac" colspan="7" width='350px'>Conciertos Confirmados</th>
                        <tr class="filac"><td class="columnac">Nombre del concierto</td><td class="columnac">Fecha</td><td class="columnac">Nombre del local</td><td class="columnac">Ciudad</td><td class="columnac">Estado</td><td class="columnac">Accion</td></tr>
                            ...
                            echo "<td> <a href='http://www.beatingbeats.es/fan/votacion_concierto.php?id_concierto=$registro->id_concierto'>Votar y Comentar</a></td>";
                            echo "</tr>";
                            }
        ...
        <div class="tablas">
                        ...
                        ?>
                        <table class="tindex" border="1">
                        <th class="columnac" colspan="7" width='350px'>Locales</th>
                        <tr class="filac"><td class="columnac">Nombre del local</td><td class="columnac">Telefono</td><td class="columnac">Email</td><td class="columnac">Direccion</td><td class="columnac">Ciudad</td><td class="columnac">Codigo postal</td><td class="columnac">Accion</td></tr>
                            ...
                            echo "<td> <a href='http://www.beatingbeats.es/fan/votacion_local.php?id_local=$registro->id_concierto'>Votar y Comentar</a></td>";
                            echo "</tr>";
                            }
                            mysqli_close($conexion);    
                            ?>
            ...
            <div class="tablas">
                        ...
                        ?>
                        <table class="tindex" border="1">
                        <th class="columnac" colspan="6" width='350px'>Grupos</th>
                        <tr class="filac"><td class="columnac">Nombre del grupo</td><td class="columnac">Fecha</td><td class="columnac">Nombre del local</td><td class="columnac">Ciudad</td><td class="columnac">Estado</td><td class="columnac">Accion</td></tr>
                        <!-- inner join de 3:usuarios,ciudad,estilo -->
                            ...
                            echo "<td> <a href='http://www.beatingbeats.es/fan/votacion_grupo.php?id_concierto=$registro->id_fan'>Votar y Comentar</a></td>";
                            echo "</tr>";
                            }
                            mysqli_close($conexion);    
                            ?>
