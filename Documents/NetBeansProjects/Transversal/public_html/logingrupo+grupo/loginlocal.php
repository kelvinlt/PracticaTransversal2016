...
$consulta=mysqli_query($conexion,"select *  from usuarios where email='".$email."' and contrasena='".$pwd_encrip."' and tipo='local'") or die ("no se puede conectar y conseguir el select");
